...
public class ServiceAvailabilityImpl implements WebService
{
    ...
    private static final String VOS_URI = "ivo://cadc.nrc.ca/vospace";
    ...
    public AvailabilityStatus getStatus()
    {
        ...
        try
        {
            ...
            availURL = regClient.getServiceURL(URI.create(VOS_URI), Standards.VOSI_AVAILABILITY, AuthMethod.ANON);
            cr = new CheckWebService(availURL.toExternalForm());
            cr.check();
